...
public class GameObjectFactory {
	...
	Mech newMech = new Mech(mechType, Integer.valueOf(mechComponents[1]), Integer.valueOf(mechComponents[2]),
		Integer.valueOf(mechComponents[3]), (Integer.valueOf(mechComponents[5]) == 1), false, false);
	...
	case "DEATHMECHITEM":
	    System.err.println(
		    "Not adding a death mech item because deathmech mech already adds deathmechitem to the level");
	    break;
	case "MINE":
